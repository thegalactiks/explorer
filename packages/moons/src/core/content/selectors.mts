...
export const pageByIdentifierSelector = <T extends Pick<ContentlayerDocumentTypes, 'identifier'>>(documents: T[]) => (identifier: string) => documents.find(_d => _d.identifier === identifier)
